...
public class DateHeaderClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = DateHeaderClientHandler.class.getSimpleName();
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		if (outbound) {
			...
			try {
				...
				System.out.printf("SOAP FAULT %s%n", e);
			}
