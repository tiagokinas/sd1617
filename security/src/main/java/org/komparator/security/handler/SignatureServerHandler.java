...
public class SignatureServerHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = SignatureServerHandler.class.getSimpleName();
