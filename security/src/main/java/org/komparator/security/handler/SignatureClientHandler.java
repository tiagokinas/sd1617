...
public class SignatureClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = SignatureClientHandler.class.getSimpleName();
